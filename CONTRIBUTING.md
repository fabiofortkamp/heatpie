...
Welcome to the contributor guide of heatpie.
...
If you experience bugs or general issues with heatpie, please have a look
...
You can help improve the documentation of heatpie by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/heatpie.git
   cd heatpie
   ```
